...
1. When generating the sample probability distribution from either noise data or photon-exposed data, care should be taken in selecting the count range over which the distribution is sampled. The selected range should avoid regions where the distribution tail becomes excessively scattered due to poor statistics.
  ...
  <br> <img width="584" height="438" alt="image" src="https://github.com/user-attachments/assets/c2fd4d55-1c9c-4ca9-8ef8-d449cf9c953e" />
  ...
  <br> <img width="584" height="438" alt="image" src="https://github.com/user-attachments/assets/e39a6a39-d58b-46da-8f44-23705b2d8366" />
   ...
   <br> <img width="584" height="438" alt="image" src="https://github.com/user-attachments/assets/efb325cc-3a38-4a3b-80f5-2235e2677a75" />
